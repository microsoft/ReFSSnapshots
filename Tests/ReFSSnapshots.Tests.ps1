...
# NOTE: Private function tests are commented out for CI compatibility
# InModuleScope requires the module to be loaded during test discovery,
# which happens before BeforeAll runs. For local testing of private functions,
# uncomment this section or create a separate test file.
